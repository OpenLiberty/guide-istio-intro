...
A virtual service defines how requests are routed to your applications through the gateway. A destination rule is used to apply policies post-routing, in this situation it is used to define service subsets that can be specifically routed to. Deploy the resources defined in `traffic.yaml`.
...
Bump the version of the microservice to `2.0-SNAPSHOT`.
...
Test the updated microservice by making requests to the testing site.
...
Bump the version of the microservice to `3.0-SNAPSHOT`.
...
[source, bash]
----
include::finish/set-live[tags=**;!copyright;]
----
...
[source, batch]
----
include::finish/set-live.bat[tags=**;!copyright;]
----
...
[source, Java]
----
include::finish/src/test/java/it/io/openliberty/guides/rest/EndpointTest.java[tags=**;!copyright;!doc]
----
