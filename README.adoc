...
Once all the pods are started, you should be able to navigate to `http://ip-address:port/api/name` to view
...
You have deployed to services to {kube} and routed requests to different versions of the `name` service based on
http headers.
