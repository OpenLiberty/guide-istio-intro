...
:page-seo-title: Istio OpenLiberty Tutorial
:page-seo-description: How to run microservices on Istio and OpenLiberty
...
Next, deploy {istio}'s resource to your cluster by running the `kubectl apply` command, which creates/updates
