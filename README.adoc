...
First, go to the https://github.com/istio/istio/releases/latest[{istio} release page^] and download Istio 1.0.6. Extract the archive and navigate to the directory with the extracted files.
