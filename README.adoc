...
traffic to certain versions of services. This feature can be leveraged to shift 100% of live traffic to blue deployments and 100%
...
----
{"greeting":"hello","version":"3.0-SNAPSHOT"}
----
