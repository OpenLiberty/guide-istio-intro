...
First, go to the https://github.com/istio/istio/releases/[{istio} release page^] and download the lastest stable release. Extract the archive and navigate to the directory with the extracted files.
